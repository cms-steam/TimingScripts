...
if args.data:
    if not args.lumis:
        ...
        print "running data with %f lumis corresponding to %f seconds" % (args.lumis[0],nSeconds)
...
if args.outfile:
    ...
    cmdstring='root -b -q -l \'TimingAndRates.cc(%f,\"%s\",\"%s\")\'' % (nSeconds,args.inputfile[0],args.outfile[0])
else:
